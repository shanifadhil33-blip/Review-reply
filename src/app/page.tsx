...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-zinc-950 font-sans selection:bg-zinc-200">
      ...
      {/* Navigation */}
      <header className="w-full flex items-center justify-between px-6 lg:px-12 py-6 bg-[#FAFAFA]">
        <div className="flex items-center gap-2">
          <Image src="/logo.png" alt="ReviewReply" width={52} height={52} className="object-contain mix-blend-multiply" />
        ...
        <div className="flex items-center gap-6">
          ...
          <Link 
            href="/signup" 
            className="bg-black text-white text-sm font-medium px-5 py-2.5 rounded-full hover:bg-zinc-800 transition-colors"
          >
            Get started free
          </Link>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center w-full">
        ...
        {/* Hero Section */}
        <section className="w-full max-w-[1000px] px-6 py-16 flex flex-col items-center text-center">
          
          <h1 className="text-[4rem] md:text-[5.5rem] leading-[1.05] tracking-tight font-medium mb-8">
          ...
          <p className="text-lg text-black max-w-2xl mb-10 font-medium leading-relaxed">
        ...
        <section className="w-full max-w-[1000px] px-6 mb-32">
          <p className="text-center text-sm font-medium text-zinc-400 mb-8 tracking-wide">TRUSTED BY LEADING MULTI-LOCATION BRANDS</p>
          <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-8 opacity-60 grayscale hover:grayscale-0 transition-all duration-300">
            {/* Local Chain Brand Logos */}
            <span className="font-bold text-xl tracking-tight">BrightPath Dental</span>
            <span className="font-medium text-xl font-serif">Greenleaf Bistro</span>
            <span className="font-black italic text-xl tracking-tighter uppercase">QuickTune Auto</span>
            <span className="font-semibold text-lg tracking-widest uppercase">CoreBase Fitness</span>
            <span className="font-light text-xl tracking-wide">The Driftwood Collection</span>
            <span className="font-extrabold text-xl lowercase">smilecraft clinics</span>
          </div>
        </section>

        {/* Value Prop Details */}
        <section className="w-full max-w-[1000px] px-6 mb-32 grid md:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-zinc-900 mb-6">Our AI crafts the perfect reply in your exact tone.</h2>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-zinc-600 font-medium">Posted automatically on Google in under 15 seconds.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-black shrink-0" />
                <span className="text-zinc-600 font-medium">Full control over your custom brand tone from one place.</span>
              </li>
            </ul>
          </div>
          <div className="relative h-[400px] w-full mt-10 md:mt-0 perspective-[1000px] group">
            <TiltCard className="w-full h-full">
              ...
              {/* Card 3 - Front (Cafe) */}
              <div className="absolute top-0 left-0 right-0 bg-white p-6 rounded-2xl shadow-xl border border-zinc-100 z-20 group-hover:-translate-y-8 group-hover:shadow-2xl transition-all duration-500 ease-out">
                 <div className="flex text-yellow-500 mb-2">★★★★★</div>
                 <p className="text-zinc-800 text-sm md:text-base font-medium mb-4">&quot;The harvest bowl was perfectly balanced, and the staff was incredibly kind even during the lunch rush. The dressing is to die for!&quot;</p>
                 <div className="bg-zinc-50 rounded-xl p-4 border border-zinc-100">
                    ...
                    <p className="text-sm text-zinc-600">Thank you so much for the wonderful review! We&apos;re thrilled to hear you enjoyed the harvest bowl. Our team always strives to provide great service, no matter how busy it gets. We can&apos;t wait to welcome you back again soon!</p>
                 </div>
              </div>
            </TiltCard>
          </div>
        ...
        <section className="w-full max-w-[800px] px-6 mb-10 relative">
           ...
           <TiltCard className="bg-black/90 backdrop-blur-3xl border border-white/10 text-white rounded-[2rem] p-8 md:p-12 text-center shadow-2xl shadow-indigo-500/10 overflow-hidden relative group">
             ...
             <p className="text-zinc-400 text-sm md:text-base max-w-xl mx-auto mb-8 relative z-10 font-light">
               One connection. Zero ongoing work. Real results.
             </p>

             <div className="grid md:grid-cols-3 gap-4 text-left relative z-10">
                <div className="p-5 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:-translate-y-1 cursor-default group/stat relative overflow-hidden">
                  ...
                  <div className="text-4xl font-semibold mb-2 text-white">5-9%</div>
                  <div className="text-base font-medium mb-2 text-zinc-200">Higher Revenue</div>
                ...
                <div className="p-5 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:-translate-y-1 cursor-default group/stat relative overflow-hidden">
                  <div className="absolute top-0 left-0 w-full h-1 bg-white opacity-0 group-hover/stat:opacity-100 transition-opacity duration-300"></div>
                  <div className="text-4xl font-semibold mb-2 text-white">100%</div>
                  <div className="text-base font-medium mb-2 text-zinc-200">Response Rate</div>
                ...
                <div className="p-5 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:-translate-y-1 cursor-default group/stat relative overflow-hidden">
                  <div className="absolute top-0 left-0 w-full h-1 bg-white opacity-0 group-hover/stat:opacity-100 transition-opacity duration-300"></div>
                  <div className="text-4xl font-semibold mb-2 text-white">0</div>
                  <div className="text-base font-medium mb-2 text-zinc-200">Hours Wasted</div>
        ...
        <section className="w-full max-w-[800px] px-6 mb-20 relative">
           ...
           <TiltCard className="bg-black/95 backdrop-blur-3xl border border-white/10 text-white rounded-[2rem] p-8 md:p-12 shadow-2xl shadow-blue-900/20 overflow-hidden relative group">
             ...
             <div className="relative z-10 flex flex-col items-center text-center">
               ...
               <h2 className="text-2xl md:text-4xl font-medium tracking-tight mb-5 leading-tight text-white">
               ...
               <p className="text-sm text-zinc-400 leading-relaxed font-light mb-7">
      ...
      <footer className="w-full bg-[#FAFAFA] border-t border-zinc-200 py-12">
        <div className="container mx-auto px-6 max-w-[1000px] flex flex-col md:flex-row items-center justify-between">
